...
export function OrderDetailCard({
  ...
  return (
    <motion.article
      ...
      className={`${compact ? "mt-3" : "mt-4"} overflow-hidden rounded-md border border-line-strong bg-surface shadow-[0_1px_2px_rgba(23,33,29,0.04)]`}
    ...
    >
      <div className="flex flex-wrap items-start justify-between gap-3 border-b border-line px-4 py-3.5">
        <div className="min-w-0">
          ...
          <h3 className="mt-1 break-all text-sm font-bold text-ink-strong" id={titleId}>
            {order.order_number}
          </h3>
